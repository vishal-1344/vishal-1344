...
I study intelligence as a dynamical process. My research focuses on adaptive inference, stability-aware
...
Modeling cognition as interconnected reasoning processes coupled through shared geometric fields and
...
My long-term research direction is to help develop intelligent systems whose reasoning is not merely
feed-forward, but dynamically regulated, structurally adaptive, and grounded in principles from
dynamical systems and control. These systems should know when to think deeper, when to stop, when
to adapt structure, and how to maintain coherent internal organization over long horizons.
